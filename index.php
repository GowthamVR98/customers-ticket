<?php
    ...
    if(isset($_POST['txtpassword']) && isset($_POST['txtusername'])){
        ...
        $result = $dbobj->selectData($dbh, TBL_PRIFIX.'user_login_details', array('user_id','concat_ws(" ",fname ,lname) as userName','password'), 'email_id = ?', $values);
        if($result['total'] > 0){
        ...
        <form action="" method="Post">
            <div class=" col-md-12 login-body">
                <div class="col-md-5 login-wish">
                    <div class="wish-blk">
                        <h3 style="font-weight: 100;">Welcome to PeerXP Support</h3>
                ...
                <div class=" col-md-6 login-blk">
                    <div class="login-blk-cell">
                        <h2 class="login-title"><img src="https://peerxp.com/wp-content/uploads/2019/04/peerxp-logo.png"></h2>
